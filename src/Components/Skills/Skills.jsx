...
const Skills = () => {
  ...
  >
   ...
   <div style={{width:"full",display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:"50px 30px",textAlign:"center",padding:"8px 12px"}} >
          {SkillsData.map(({ id, src, title, style }) => (
            ...
            >
              <img src={src} alt="" style={{width:"40%",margin:"auto"}} />
